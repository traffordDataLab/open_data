...
datatable(df, 
          ...
          caption = tags$caption(
            ...
            em("Fast food outlets in Trafford")),
          width = "100%",
          ...
          options = list(
            ...
            columnDefs = list(
              ...
              list(targets = 4:5, searchable = FALSE)
              )))
```
