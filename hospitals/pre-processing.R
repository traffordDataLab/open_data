...
# filter data ---------------------------
sites <- filter(polygons, CLASSIFICA == "Hospital")
...
st_write(sf_gm, "gm_hospitals.geojson", driver = "GeoJSON")
st_write(sf_trafford, "trafford_hospitals.geojson", driver = "GeoJSON")
