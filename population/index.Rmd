---
pagetitle: "Mid-2019 population estimates"
lang: "en-GB"
output:
  html_document:
...
df <- read_csv("https://github.com/traffordDataLab/open_data/raw/master/population/mid-2019_population_estimates_ward.csv") %>% 
...
<h1>Mid-2019 population estimates</h1>
*Estimates of the usual resident population in Trafford during mid-2019 (all geographies).*<br />
*Estimates of the usual resident population in Trafford during mid-2020 (Local Authority level only).*
...
<table id="metadata" class="table table-condensed">
  ...
  <tr>
    ...
    <td><a href="https://www.ons.gov.uk/peoplepopulationandcommunity/populationandmigration/populationestimates/bulletins/annualmidyearpopulationestimates/mid2019" target="_blank">Office for National Statistics</a></td>
    <td><time datetime="2019-06-30">2019-06-30</time></td>
    ...
    <td><time datetime="2021-06-28">2021-06-21</time></td>
  </tr>
</table>
...
```
<div id="tableFooterTitle">Mid-2019 population estimates for Trafford's wards</div>
...
|File name |Format |
|---|---|
|[mid-2020_population_estimates_local_authority.csv](mid-2020_population_estimates_local_authority.csv) |CSV |
|[mid-2019_population_estimates_all_geographies.csv](mid-2019_population_estimates_all_geographies.csv) |CSV |
|[mid-2019_population_estimates_local_authority.csv](mid-2019_population_estimates_local_authority.csv) |CSV |
|[mid-2019_population_estimates_ward.csv](mid-2019_population_estimates_ward.csv) |CSV |
|[mid-2019_population_estimates_msoa.csv](mid-2019_population_estimates_msoa.csv) |CSV |
|[mid-2019_population_estimates_lsoa.csv](mid-2019_population_estimates_lsoa.csv) |CSV |
|[mid-2019_population_estimates_oa.csv](mid-2019_population_estimates_oa.csv) |CSV |

<h2>Pre-processing</h2>
[The R script used to process the data](pre-processing.Rmd) can be adapted to other areas. For information about R visit the <a href="https://cran.r-project.org" target="_blank">CRAN website</a>.
