---
pagetitle: "Mid-2020 population estimates"
lang: "en-GB"
output:
  html_document:
...
df <- read_csv("mid-year_population_estimates_ward.csv") %>% 
...
<h1>Mid-2020 population estimates</h1>
*Estimates of the usual resident population in Trafford during mid-2020.*
...
<table id="metadata" class="table table-condensed">
  ...
  <tr>
    ...
    <td><a href="https://www.ons.gov.uk/peoplepopulationandcommunity/populationandmigration/populationestimates/bulletins/annualmidyearpopulationestimates/mid2020" target="_blank">Office for National Statistics</a></td>
    <td><time datetime="2020-06-30">2020-06-30</time></td>
...
```
<div id="tableFooterTitle">Mid-2020 population estimates for Trafford's wards</div>
...
|File name |Format |
|---|---|
|[mid-year_population_estimates_all_geographies.csv](mid-year_population_estimates_all_geographies.csv) |CSV |
|[mid-year_population_estimates_local_authority.csv](mid-year_population_estimates_local_authority.csv) |CSV |
|[mid-year_population_estimates_ward.csv](mid-year_population_estimates_ward.csv) |CSV |
|[mid-year_population_estimates_msoa.csv](mid-year_population_estimates_msoa.csv) |CSV |
|[mid-year_population_estimates_lsoa.csv](mid-year_population_estimates_lsoa.csv) |CSV |
|[mid-year_population_estimates_oa.csv](mid-year_population_estimates_oa.csv) |CSV |
