...
# load data ---------------------------
raw <- read_csv("https://www.cqc.org.uk/sites/default/files/26_September_2018_CQC_directory.csv", 
...
# write data  ---------------------------
write_csv(df, "gm_dentists.csv")
write_csv(filter(df, area_name == "Trafford"), "trafford_dentists.csv")
st_write(sf, "gm_dentists.geojson")
st_write(filter(sf, `Area name` == "Trafford"), "trafford_dentists.geojson")
