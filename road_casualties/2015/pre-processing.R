## STATS19 road casualty data - 2015 ##
...
download.file(url, dest = "dftRoadSafetyData_Casualties_2015.zip")
unzip("dftRoadSafetyData_Casualties_2015.zip")
file.remove("dftRoadSafetyData_Casualties_2015.zip")
casualty <- read.csv("Casualties_2015.csv")

url <- "http://data.dft.gov.uk/road-accidents-safety-data/RoadSafetyData_Accidents_2015.zip"
download.file(url, dest = "dftRoadSafety_Accidents_2015.zip")
unzip("dftRoadSafety_Accidents_2015.zip")
file.remove("dftRoadSafety_Accidents_2015.zip")
accident <- read.csv("Accidents_2015.csv") %>% 
...
## ----- write data
write_csv(casualties, "STATS19_casualty_data_2015.csv")
casualties %>% 
  st_as_sf(crs = 4326, coords = c("long", "lat")) %>% 
  st_write("STATS19_casualty_data_2015.geojson", driver = "GeoJSON")
