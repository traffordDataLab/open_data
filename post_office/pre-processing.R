...
# filter data ---------------------------
sites <- filter(polygons, CLASSIFICA == "Post Office")
...
st_write(sf_gm, "gm_post_offices.geojson", driver = "GeoJSON")
st_write(sf_trafford, "trafford_post_offices.geojson", driver = "GeoJSON")
