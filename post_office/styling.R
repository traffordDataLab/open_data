...
# read data ---------------------------
geojson <- st_read("http://trafforddatalab.io/open_data/post_office/trafford_post_offices.geojson")
...
# write data ---------------------------
st_write(geojson_styles, "trafford_post_offices_styled.geojson")
