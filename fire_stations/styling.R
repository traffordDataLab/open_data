...
# read data ---------------------------
geojson <- st_read("http://trafforddatalab.io/open_data/fire_stations/trafford_fire_stations.geojson")
...
# write data ---------------------------
st_write(geojson_styles, "trafford_fire_stations_styled.geojson")
