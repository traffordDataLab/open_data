...
<table id="metadata" class="table table-condensed">
  ...
  <tr>
    ...
    <td><time datetime="2022-07-15">2022-07-15</time></td>
  </tr>
</table>
...
|[2021_households_la_gm.csv](2021_households_la_gm.csv) |CSV |
...
The R scripts used to process the data for the [2021 first data release](pre-processing-first-release.R) and the [1981-2021 time series datasets](pre-processing-time-series.R) can be adapted to other areas. For information about R visit the <a href="https://cran.r-project.org" target="_blank">CRAN website</a>.
