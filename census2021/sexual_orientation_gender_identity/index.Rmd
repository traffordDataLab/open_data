---
pagetitle: "Census 2021: Sexual orientation and gender identity"
lang: "en-GB"
output:
  html_document:
...
df <- read_csv("2021_gender_identity_detailed_la_gm.csv") %>%
...
<h1>Census 2021: Sexual orientation and gender identity</h1>
*Census 2021 estimates that classify usual residents in England and Wales by their self-reported sexual orientation and by their gender identity.*
...
<table id="metadata" class="table table-condensed">
  ...
  <tr>
    ...
    <td>Local authority (<abbr>LA<abbr>), Middle-layer Super Output Area (<abbr>MSOA</abbr>)</td>
    ...
    <td><time datetime="2023-01-13">2023-01-13</time></td>
  </tr>
</table>
...
```
<div id="tableFooterTitle">Population of Local Authorities in Greater Manchester classified by gender identity (detailed)</div>
...
<h3>Gender identity (Persons)</h3>
|File name |Geography |
|---|---|
|[2021_gender_identity_detailed_la_gm.csv](2021_gender_identity_detailed_la_gm.csv) |<abbr title="Local Authority">LA</abbr> |
|[2021_gender_identity_la_gm.csv](2021_gender_identity_la_gm.csv) |<abbr title="Local Authority">LA</abbr> |
|[2021_gender_identity_msoa_trafford.csv](2021_gender_identity_msoa_trafford.csv) |<abbr title="Middle-layer Super Output Area">MSOA</abbr> |

<h3>Sexual orientation (Persons)</h3>
|File name |Geography |
|---|---|
|[2021_sexual_orientation_detailed_la_gm.csv](2021_sexual_orientation_detailed_la_gm.csv) |<abbr title="Local Authority">LA</abbr> |
|[2021_sexual_orientation_la_gm.csv](2021_sexual_orientation_la_gm.csv) |<abbr title="Local Authority">LA</abbr> |
|[2021_sexual_orientation_msoa_trafford.csv](2021_sexual_orientation_msoa_trafford.csv) |<abbr title="Middle-layer Super Output Area">MSOA</abbr> |
