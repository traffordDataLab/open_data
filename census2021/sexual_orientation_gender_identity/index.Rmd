...
<table id="metadata" class="table table-condensed">
  ...
  <tr>
    ...
    <td>Local authority (la), Middle-layer Super Output Area (msoa)</td>
...
|File name |Format |
|---|---|
|[2021_gender_identity_detailed_la_gm.csv](2021_gender_identity_detailed_la_gm.csv) |CSV |
|[2021_gender_identity_la_gm.csv](2021_gender_identity_la_gm.csv) |CSV |
|[2021_gender_identity_msoa_trafford.csv](2021_gender_identity_msoa_trafford.csv) |CSV |
|[2021_sexual_orientation_detailed_la_gm.csv](2021_sexual_orientation_detailed_la_gm.csv) |CSV |
|[2021_sexual_orientation_la_gm.csv](2021_sexual_orientation_la_gm.csv) |CSV |
|[2021_sexual_orientation_msoa_trafford.csv](2021_sexual_orientation_msoa_trafford.csv) |CSV |
