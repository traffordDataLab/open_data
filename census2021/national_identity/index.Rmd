---
pagetitle: "Census 2021: National Identity"
lang: "en-GB"
output:
  html_document:
...
df <- read_csv("2021_population_national_identity_detailed_la_gm.csv") %>%
...
<h1>Census 2021: National Identity</h1>
*Census 2021 estimates that classify usual residents in England and Wales by national identity.*
...
```
<div id="tableFooterTitle">Population of Local Authorities in Greater Manchester classified by national identity (detailed)</div>

<h2>Data</h2>
<span id ="downloads">Download the complete datasets using the following links:</span>

<h3>National identity - UK (Persons)</h3>
|File name |Geography |
|---|---|
|[2021_population_national_identity_uk_focus_la_gm.csv](2021_population_national_identity_uk_focus_la_gm.csv) |<abbr title="Local Authority">LA</abbr> |
|[2021_population_national_identity_uk_focus_msoa_trafford.csv](2021_population_national_identity_uk_focus_msoa_trafford.csv) |<abbr title="Middle-layer Super Output Area">MSOA</abbr> |
|[2021_population_national_identity_uk_focus_lsoa_trafford.csv](2021_population_national_identity_uk_focus_lsoa_trafford.csv) |<abbr title="Lower-layer Super Output Area">LSOA</abbr> |
|[2021_population_national_identity_uk_focus_oa_trafford.csv](2021_population_national_identity_uk_focus_oa_trafford.csv) |<abbr title="Output Area">OA</abbr> |
|[2021_population_national_identity_uk_focus_ward_trafford.csv](2021_population_national_identity_uk_focus_ward_trafford.csv) |<abbr title="Electoral Ward">Ward</abbr> |

<h3>National identity - detailed (Persons)</h3>
|File name |Geography |
|---|---|
|[2021_population_national_identity_detailed_la_gm.csv](2021_population_national_identity_detailed_la_gm.csv) |<abbr title="Local Authority">LA</abbr> |
|[2021_population_national_identity_detailed_msoa_trafford.csv](2021_population_national_identity_detailed_msoa_trafford.csv) |<abbr title="Middle-layer Super Output Area">MSOA</abbr> |
|[2021_population_national_identity_detailed_ward_trafford.csv](2021_population_national_identity_detailed_ward_trafford.csv) |<abbr title="Electoral Ward">Ward</abbr> |
