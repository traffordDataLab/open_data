...
<table id="metadata" class="table table-condensed">
  ...
  <tr>
    ...
    <td><time datetime="2020-04-15">2020-04-15</time></td>
    <td>Point data</td>
    ...
    <td><time datetime="2020-04-20">2020-04-20</time></td>
  </tr>
</table>
...
```
<div id="tableFooterTitle">Nursing and residential care homes in Trafford</div>
...
|File name |Format |
|---|---|
|[trafford_care_homes.csv](trafford_care_homes.csv) |CSV |
|[trafford_care_homes.geojson](trafford_care_homes.geojson) |GeoJSON |
