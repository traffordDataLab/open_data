...
df <- read_csv("trafford_care_homes.csv") %>% 
  rename_all(. %>% str_to_title() %>% str_replace_all("_", " ")) %>% 
  rename(`CQC id` = `Cqc id`)
```
...
# Care homes
*Nursing and residential care homes in Trafford*
<br />
</header>
<main>
## Metadata
...
|:---|:---|:---|:---|:---|:---|:---|
|Care Quality Commission |<a href="http://www.cqc.org.uk/about-us/transparency/using-cqc-data" target="_blank">Care Quality Commission</a> |2020-04-15 |Point data |<a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">OGL v3.0</a> |Contains public sector information licensed under the Open Government Licence v3.0 |2020-04-20 |

## Preview
Sort, filter and export a selection of the data using the table. An <a href="https://www.trafforddatalab.io/explore/#dataset=care_homes" target="_blank">interactive map</a> is also available.
...
<div style="text-align: center; color: #555;">
  <em>Nursing and residential care homes in Trafford</em>
</div>
...
|File name |Format |
|:---|:---|
|[trafford_care_homes](trafford_care_homes.csv) |CSV |
|[trafford_care_homes](trafford_care_homes.geojson) |GeoJSON |
