...
<table id="metadata" class="table table-condensed">
  ...
  <tr>
    <td>Source name</td>
    <td><a href="#" target="_blank">Publisher name</a></td>
...
```
<div id="tableFooterTitle">table_caption</div>
...
|File name |Format |
|---|---|
|[trafford_dataset_name.csv](trafford_dataset_name.csv) |CSV |
|[trafford_dataset_name.geojson](trafford_dataset_name.geojson) |GeoJSON |
