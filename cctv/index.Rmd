...
<table id="metadata" class="table table-condensed">
  ...
  <tr>
    ...
    <td><a href="https://www.trafforddatalab.io/open_data/cctv" target="_blank">Trafford Council</a></td>
    <td><time datetime="2018-05">2018-05</time></td>
    <td>Point data</td>
    ...
    <td><time datetime="2019-04-12">2019-04-12</time></td>
  </tr>
</table>
...
```
<div id="tableFooterTitle">Local Authority controlled CCTV cameras in Trafford</div>
...
|File name |Format |
|---|---|
|[trafford_cctv_cameras.csv](trafford_cctv_cameras.csv) |CSV |
|[trafford_cctv_cameras.geojson](trafford_cctv_cameras.geojson) |GeoJSON |
