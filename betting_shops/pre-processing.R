...
# write data   ---------------------------
write_csv(df_postcodes, "bettingshops_gm.csv")
st_write(sf, "bettingshops_gm.geojson")

write_csv(filter(df_postcodes, area_name == "Trafford"), "bettingshops_trafford.csv")
st_write(filter(sf, area_name == "Trafford"), "bettingshops_trafford.geojson")
