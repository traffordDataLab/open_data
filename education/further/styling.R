...
# read data ---------------------------
geojson <- st_read("http://trafforddatalab.io/open_data/education/trafford_further_education.geojson")
...
# write data ---------------------------
st_write(geojson_styles, "trafford_further_education_styled.geojson")
