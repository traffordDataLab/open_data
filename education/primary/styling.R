...
# read data ---------------------------
geojson <- st_read("http://trafforddatalab.io/open_data/education/trafford_primary_schools.geojson")
...
# write data ---------------------------
st_write(geojson_styles, "trafford_primary_schools_styled.geojson")
