...
# read data ---------------------------
geojson <- st_read("http://trafforddatalab.io/open_data/education/trafford_special_schools.geojson")
...
# write data ---------------------------
st_write(geojson_styles, "trafford_special_schools_styled.geojson")
