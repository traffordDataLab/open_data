...
# filter data ---------------------------
sites <- filter(polygons, BUILDGTHEM == "Education" & CLASSIFICA == "Special Needs Education")
...
st_write(sf_gm, "gm_special_schools.geojson", driver = "GeoJSON")
st_write(sf_trafford, "trafford_special_schools.geojson", driver = "GeoJSON")
