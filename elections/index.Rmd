...
<table id="metadata" class="table table-condensed">
  ...
  <tr>
    ...
    <td><time datetime="2026-05-11">2026-05-11</time></td>
  </tr>
</table>
...
<h2>Notes</h2>
Conforms to the specification described in the <a href="https://files.esd.org.uk/vgTJ3" target="_blank">local transparency guidance - publishing elections results data</a> document by the Local Government Association.
