...
<table id="metadata" class="table table-condensed">
  ...
  <tr>
    ...
    <td><time datetime="2021-06-16">2021-06-16</time></td>
  </tr>
</table>
...
<h2>Notes</h2>
Conforms to the specification described in the <a href="http://e-sd.org/vgTJ3" target="_blank">local transparency guidance - publishing elections results data</a> document by the Local Government Association. Validated using the <a href="https://validator.opendata.esd.org.uk/electionresults" target="_blank">Local Government Association data validator tool</a> on <time datetime="2021-06-16">2021-06-16</time>.
