---
pagetitle: "Patients Registered at a GP Practice"
lang: "en-GB"
output:
  html_document:
...
df <- read_csv("trafford_gp_patient_registrations.csv") %>% 
...
<h1>Patients Registered at a GP Practice</h1>
*Number of patients registered at GP Practices in Trafford.*
</header>
...
<table id="metadata" class="table table-condensed">
  ...
  <tr>
    <td>NHS Digital</td>
    <td><a href="https://digital.nhs.uk/data-and-information/publications/statistical/patients-registered-at-a-gp-practice" target="_blank">NHS Digital</a></td>
    <td><time datetime="2022-05-01">2022-05-01</time></td>
    <td>Electoral ward, MSOA, Trafford Locality</td>
    ...
    <td><time datetime="2022-06-10">2022-06-10</time></td>
  </tr>
</table>
...
```
<div id="tableFooterTitle">Number of patients registered at Trafford GP Practices</div>
...
|File name |Format |
|---|---|
|[trafford_gp_patient_registrations.csv](trafford_gp_patient_registrations.csv) |CSV |
