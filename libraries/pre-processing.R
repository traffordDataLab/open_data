...
# filter data ---------------------------
sites <- filter(polygons, CLASSIFICA == "Library")
...
st_write(sf_gm, "gm_libraries.geojson", driver = "GeoJSON")
st_write(sf_trafford, "trafford_libraries.geojson", driver = "GeoJSON")
